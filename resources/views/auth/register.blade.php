        ...
        <div style="padding:100px 80px;width: 100%;">
            <div style="box-shadow: 0 2px 3px rgba(10, 10, 10, 0.1), 0 0 0 1px rgba(10, 10, 10, 0.1);">
                ...
                <div style="height: 250px;background-color: #D7D7D7;border-radius: 0 0 8px 8px">
                    <form method="POST" action="{{ route('register') }}" style="text-align: center;padding: 15px">
                        @csrf
                        <div>
                            <label>帐&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;号&nbsp;： &nbsp;</label>
                            <input type="text" style="width: 200px" name="username" value="{{ old('username') }}" placeholder="6-20位数字+英文字母">
                        </div>
                        <div style="margin-top: 5px">
                            <label>密&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;码&nbsp;： &nbsp;</label>
                            <input type="password" style="width: 200px;" name="password" value="{{ old('password') }}" placeholder="6-20位数字+英文字母">
                        </div>
                        <div style="margin-top: 5px">
                            <label>确认密码&nbsp;： &nbsp;</label>
                            <input type="password" style="width: 200px;" name="password_confirmation" placeholder="确认密码">
                        </div>
                        <div style="margin-top: 5px">
                            <label>密保问题&nbsp;： &nbsp;</label>
                            <input type="text" style="width: 200px;" name="security_question" value="{{ old('security_question') }}" placeholder="请输入一个自定义问题，并牢记">
                        </div>
                        <div style="margin-top: 5px">
                            <label>密保答案&nbsp;： &nbsp;</label>
                            <input type="text" style="width: 200px;" name="classified_answer" value="{{ old('classified_answer') }}" placeholder="请输入一个自定义答案，并牢记">
                        </div>
                        {{--<div style="margin-top: 5px">--}}
                            {{--<label>推&nbsp;&nbsp;荐&nbsp;&nbsp;码 ： &nbsp;</label>--}}
                            {{--<input type="text" style="width: 200px;" name="code" value="{{ old('code') }}">--}}
                            {{--<label style="font-size: 12px;font-weight: normal;">&nbsp;&nbsp;* 请输入推荐码</label>--}}
                        {{--</div>--}}

                        <div style="margin-top: 5px;float: left">
                            <input type="submit" value="注    册" style="margin-left: 135px;font-size: 12px;cursor: pointer;padding: 4px 26px">
